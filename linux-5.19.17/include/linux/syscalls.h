...
#define SYSCALL_TRACE_ENTER_EVENT(sname)                        \
  ...
  static struct trace_event_call __used __section(              \
      "_ftrace_events") *__event_enter_##sname = &event_enter_##sname;
...
#ifdef TIF_FSCHECK
  if (!test_thread_flag(TIF_FSCHECK)) return;
#endif
...
asmlinkage long sys_timerfd_settime(
...
asmlinkage long sys_timerfd_settime32(
...
asmlinkage long sys_futex_time32(u32 __user *uaddr, int op, u32 val,
                                 ...
                                 u32 __user *uaddr2, u32 val3);
asmlinkage long sys_get_robust_list(
...
asmlinkage long sys_sched_rr_get_interval(
    pid_t pid, struct __kernel_timespec __user *interval);
asmlinkage long sys_sched_rr_get_interval_time32(
...
asmlinkage long sys_mq_timedreceive(
...
asmlinkage long sys_mq_timedreceive_time32(
    mqd_t mqdes, char __user *u_msg_ptr, unsigned int msg_len,
    unsigned int __user *u_msg_prio,
    const struct old_timespec32 __user *u_abs_timeout);
asmlinkage long sys_mq_timedsend_time32(
...
asmlinkage long sys_semtimedop(int semid, struct sembuf __user *sops,
                               unsigned nsops,
                               const struct __kernel_timespec __user *timeout);
asmlinkage long sys_semtimedop_time32(
